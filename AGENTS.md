...
This project is indexed by GitNexus as **AGENTOS** (482 symbols, 1002 relationships, 28 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
