...
REQUIRED_FILES = [
    ...
    ".claude/skills/error-learning/SKILL.md",
    ".agents/skills/error-learning/SKILL.md",
    ".claude/skills/error-neat/SKILL.md",
    ".agents/skills/error-neat/SKILL.md",
    ".claude/skills/wiki-maintenance/SKILL.md",
    ".agents/skills/wiki-maintenance/SKILL.md",
    ".claude/skills/project-memory-bootstrap/SKILL.md",
    ".agents/skills/project-memory-bootstrap/SKILL.md",
    ".claude/skills/neat-freak/SKILL.md",
    ".agents/skills/neat-freak/SKILL.md",
    ".claude/skills/writing-agent-md/SKILL.md",
    ".agents/skills/writing-agent-md/SKILL.md",
